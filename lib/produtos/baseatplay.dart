...
class Baseatplay extends StatefulWidget {
  @override
  _BaseatplayState createState() => new _BaseatplayState();
}

class _BaseatplayState extends State<Baseatplay> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Baseatplay");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Base Líquida At Play"),
