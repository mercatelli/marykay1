...
class Basecremepo extends StatefulWidget {
  @override
  _BasecremepoState createState() => new _BasecremepoState();
}

class _BasecremepoState extends State<Basecremepo> {
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Bases Creme Efeito Pó"),
