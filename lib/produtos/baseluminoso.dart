...
class Baseluminoso extends StatefulWidget {
  @override
  _BaseluminosoState createState() => new _BaseluminosoState();
}

class _BaseluminosoState extends State<Baseluminoso> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Baseluminoso");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Base Líquida Acab.Luminoso"),
