...
class Basemedia extends StatefulWidget {
  @override
  _BasemediaState createState() => new _BasemediaState();
}

class _BasemediaState extends State<Basemedia> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Basemedia");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Bases Cobertura Média"),
