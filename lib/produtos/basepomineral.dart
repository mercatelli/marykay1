...
class Basepomineral extends StatefulWidget {
  @override
  _BasepomineralState createState() => new _BasepomineralState();
}

class _BasepomineralState extends State<Basepomineral> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Basepomineral");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Base em Pó Mineral"),
