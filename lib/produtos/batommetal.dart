...
class Batommetal extends StatefulWidget {
  @override
  _BatommetalState createState() => new _BatommetalState();
}

class _BatommetalState extends State<Batommetal> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Batommetal");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Batom Líquido Metálico"),
