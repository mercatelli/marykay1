...
class Blushmineral extends StatefulWidget {
  @override
  _BlushmineralState createState() => new _BlushmineralState();
}

class _BlushmineralState extends State<Blushmineral> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Blushmineral");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
