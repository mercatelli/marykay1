...
class Botanicaleffects extends StatefulWidget {
  @override
  _BotanicaleffectsState createState() => new _BotanicaleffectsState();
}

class _BotanicaleffectsState extends State<Botanicaleffects> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Botanicaleffects");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Botanical Effects"),
