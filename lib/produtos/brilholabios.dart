...
class Brilholabios extends StatefulWidget {
  @override
  _BrilholabiosState createState() => new _BrilholabiosState();
}

class _BrilholabiosState extends State<Brilholabios> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Brilholabios");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Brilho para os Lábios"),
