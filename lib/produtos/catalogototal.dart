...
import 'package:marykay1/bases.dart';
...
class Catalogototal extends StatefulWidget {
  @override
  _CatalogototalState createState() => new _CatalogototalState();
}

class _CatalogototalState extends State<Catalogototal> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Basecremepo");
    databaseReference2 = database.reference().child("Baseluminoso");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    databaseReference2.onChildAdded.listen(_onEntryAdded);
    databaseReference2.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Selecione os itens"),
  ...
  void handleSubmit() {
    ...
    if (form.validate()) {
      ...
      databaseReference2.push().set(board.toJson());
    }
  }
