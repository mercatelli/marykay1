...
class Catlgonline extends StatefulWidget {
  @override
  _CatlgonlineState createState() => new _CatlgonlineState();
}

class _CatlgonlineState extends State<Catlgonline> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Bases");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Bases Líquidas Matte"),
