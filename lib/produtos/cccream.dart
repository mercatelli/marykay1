...
class Cccream extends StatefulWidget {
  @override
  _CccreamState createState() => new _CccreamState();
}

class _CccreamState extends State<Cccream> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Cccream");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
