...
class Clearproof extends StatefulWidget {
  @override
  _ClearproofState createState() => new _ClearproofState();
}

class _ClearproofState extends State<Clearproof> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Clearproof");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
