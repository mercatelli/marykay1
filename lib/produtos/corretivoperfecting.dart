...
class Corretivoperfecting extends StatefulWidget {
  @override
  _CorretivoperfectingState createState() => new _CorretivoperfectingState();
}

class _CorretivoperfectingState extends State<Corretivoperfecting> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Corretivoperfecting");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Corretivo Perfecting Concealer"),
