...
class Cuidados3d extends StatefulWidget {
  @override
  _Cuidados3dState createState() => new _Cuidados3dState();
}

class _Cuidados3dState extends State<Cuidados3d> {
  double price = 0.0;
  double result = 0.0;
  String _finalResult = "";
  int counter = int.parse(globals.carregaqtd, radix:10);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Cuidados com a Pele"),
