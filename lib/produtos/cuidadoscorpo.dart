...
class Cuidadoscorpo extends StatefulWidget {
  @override
  _CuidadoscorpoState createState() => new _CuidadoscorpoState();
}

class _CuidadoscorpoState extends State<Cuidadoscorpo> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Cuidadoscorpo");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Cuidados com o Corpo"),
