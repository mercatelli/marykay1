...
class Cuidadosidade extends StatefulWidget {
  @override
  _CuidadosidadeState createState() => new _CuidadosidadeState();
}

class _CuidadosidadeState extends State<Cuidadosidade> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Cuidadosidade");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Cuidados Anti-idade Rosto"),
