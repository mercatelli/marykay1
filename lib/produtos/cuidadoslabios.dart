...
class Cuidadoslabios extends StatefulWidget {
  @override
  _CuidadoslabiosState createState() => new _CuidadoslabiosState();
}

class _CuidadoslabiosState extends State<Cuidadoslabios> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Cuidadoslabios");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Cuidados Person. Lábios"),
