...
class Cuidadospersonal extends StatefulWidget {
  @override
  _CuidadospersonalState createState() => new _CuidadospersonalState();
}

class _CuidadospersonalState extends State<Cuidadospersonal> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Cuidadospersonal");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Cuidados Rosto e Corpo"),
