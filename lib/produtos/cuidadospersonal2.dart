...
class Cuidadospersonal2 extends StatefulWidget {
  @override
  _Cuidadospersonal2State createState() => new _Cuidadospersonal2State();
}

class _Cuidadospersonal2State extends State<Cuidadospersonal2> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Cuidadospersonal2");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Cuidados Personalizados"),
