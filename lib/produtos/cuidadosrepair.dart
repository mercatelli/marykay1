...
class Cuidadosrepair extends StatefulWidget {
  @override
  _CuidadosrepairState createState() => new _CuidadosrepairState();
}

class _CuidadosrepairState extends State<Cuidadosrepair> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Cuidadosrepair");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Cuidados TimeWise Repair"),
