...
class Delineadores extends StatefulWidget {
  @override
  _DelineadoresState createState() => new _DelineadoresState();
}

class _DelineadoresState extends State<Delineadores> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Delineadores");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
