...
class Esponjas extends StatefulWidget {
  @override
  _EsponjasState createState() => new _EsponjasState();
}

class _EsponjasState extends State<Esponjas> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Esponjas");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
