...
class Estojos extends StatefulWidget {
  @override
  _EstojosState createState() => new _EstojosState();
}

class _EstojosState extends State<Estojos> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Estojos");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
