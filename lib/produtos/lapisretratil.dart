...
class Lapisretratil extends StatefulWidget {
  @override
  _LapisretratilState createState() => new _LapisretratilState();
}

class _LapisretratilState extends State<Lapisretratil> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Lapisretratil");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Lápis Retrátil para os Lábios"),
