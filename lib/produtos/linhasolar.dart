...
class Linhasolar extends StatefulWidget {
  @override
  _LinhasolarState createState() => new _LinhasolarState();
}

class _LinhasolarState extends State<Linhasolar> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Linhasolar");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
