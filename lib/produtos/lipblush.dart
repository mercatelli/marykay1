...
class Lipblush extends StatefulWidget {
  @override
  _LipblushState createState() => new _LipblushState();
}

class _LipblushState extends State<Lipblush> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Lipblush");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
