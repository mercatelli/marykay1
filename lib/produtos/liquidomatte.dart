...
import 'package:marykay1/batons.dart';
...
class Liquidomatte extends StatefulWidget {
  @override
  _LiquidomatteState createState() => new _LiquidomatteState();
}

class _LiquidomatteState extends State<Liquidomatte> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Liquidomatte");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Batom Líquido Matte At Play®"),
