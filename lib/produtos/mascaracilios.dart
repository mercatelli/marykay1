...
class Mascaracilios extends StatefulWidget {
  @override
  _MascaraciliosState createState() => new _MascaraciliosState();
}

class _MascaraciliosState extends State<Mascaracilios> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Mascaracilios");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Máscara para os Cílios"),
