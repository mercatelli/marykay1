...
class Matte extends StatefulWidget {
  @override
  _MatteState createState() => new _MatteState();
}

class _MatteState extends State<Matte> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Matte");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Batom Matte Mary Kay®"),
