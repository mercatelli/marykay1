...
class Mkmen extends StatefulWidget {
  @override
  _MkmenState createState() => new _MkmenState();
}

class _MkmenState extends State<Mkmen> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Mkmen");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
