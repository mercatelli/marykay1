...
class Perfeminino extends StatefulWidget {
  @override
  _PerfemininoState createState() => new _PerfemininoState();
}

class _PerfemininoState extends State<Perfeminino> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Perfeminino");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Perfumes Femininos"),
