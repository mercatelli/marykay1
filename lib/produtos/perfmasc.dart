...
class Perfmasc extends StatefulWidget {
  @override
  _PerfmascState createState() => new _PerfmascState();
}

class _PerfmascState extends State<Perfmasc> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Perfmasc");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Perfumes Masculinos"),
