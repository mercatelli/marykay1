...
class Pinceis extends StatefulWidget {
  @override
  _PinceisState createState() => new _PinceisState();
}

class _PinceisState extends State<Pinceis> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Pinceis");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Novos Pinceis Mary Kay®"),
