...
class Pinceis2 extends StatefulWidget {
  @override
  _Pinceis2State createState() => new _Pinceis2State();
}

class _Pinceis2State extends State<Pinceis2> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Pinceis2");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Pincéis Mary Kay®"),
