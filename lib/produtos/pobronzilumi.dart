...
class Pobronzilumi extends StatefulWidget {
  @override
  _PobronzilumiState createState() => new _PobronzilumiState();
}

class _PobronzilumiState extends State<Pobronzilumi> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Pobronzilumi");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Pó Bronzeador & Iluminador"),
