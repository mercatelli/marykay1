...
class Posolto extends StatefulWidget {
  @override
  _PosoltoState createState() => new _PosoltoState();
}

class _PosoltoState extends State<Posolto> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Posolto");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Pó Solto Translúcido"),
