...
class Propalette extends StatefulWidget {
  @override
  _PropaletteState createState() => new _PropaletteState();
}

class _PropaletteState extends State<Propalette> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Propalette");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Pro Palette - Edição Especial"),
