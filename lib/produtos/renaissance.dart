...
class Renaissance extends StatefulWidget {
  @override
  _RenaissanceState createState() => new _RenaissanceState();
}

class _RenaissanceState extends State<Renaissance> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Renaissance");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Renaissance Revival"),
