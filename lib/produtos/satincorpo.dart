...
class Satincorpo extends StatefulWidget {
  @override
  _SatincorpoState createState() => new _SatincorpoState();
}

class _SatincorpoState extends State<Satincorpo> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Satincorpo");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
    ...
    return WillPopScope(
      ...
      child: new Scaffold(
        appBar: new AppBar(
          ...
          title: new Text("Cuidados com o Corpo - Satin"),
