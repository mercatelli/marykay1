...
class Satinmaos extends StatefulWidget {
  @override
  _SatinmaosState createState() => new _SatinmaosState();
}

class _SatinmaosState extends State<Satinmaos> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Satinmaos");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
