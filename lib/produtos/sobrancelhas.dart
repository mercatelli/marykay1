...
class Sobrancelhas extends StatefulWidget {
  @override
  _SobrancelhasState createState() => new _SobrancelhasState();
}

class _SobrancelhasState extends State<Sobrancelhas> {
  ...
  void initState() {
    ...
    board = Board("", "", "");
    databaseReference = database.reference().child("Sobrancelhas");
    databaseReference.onChildAdded.listen(_onEntryAdded);
    databaseReference.onChildChanged.listen(_onEntryChanged);
